function analysis = analysis_defaults()
...
analysis.PriorPar.mu = 0.5;
analysis.PriorPar.beta = 0.25;
% will become 'W*eye(D)';
analysis.PriorPar.W = 50;
analysis.PriorPar.v = 5;
analysis.PriorPar.ua = 1;
analysis.PriorPar.uad = 0;
